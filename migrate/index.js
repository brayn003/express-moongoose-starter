...
async function initUmzug() {
  ...
  umzug.on('migrating', (name) => { console.log(chalk`{blue [Migrating]} {bold ${name}}`); });
  umzug.on('migrated', (name) => { console.log(chalk`{blue [Migrated]} {bold ${name}}`); });
  umzug.on('reverting', (name) => { console.log(chalk`{blue [Reverting]} {bold ${name}}`); });
  umzug.on('reverted', (name) => { console.log(chalk`{blue [Reverted]} {bold ${name}}`); });
